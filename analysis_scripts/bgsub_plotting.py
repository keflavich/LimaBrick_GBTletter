...
specHDU22bg.writeto("BackgroundH2CO_22.fits",clobber=True)
specHDU22 = fits.PrimaryHDU(data=fgspec,header=spechead)
specHDU22.writeto("BrickSpectrumH2CO_22.fits",clobber=True)
...
specHDU11bg.writeto("BackgroundH2CO_11.fits",clobber=True)
specHDU11 = fits.PrimaryHDU(data=fgspec,header=spechead)
specHDU11.writeto("BrickSpectrumH2CO_11.fits",clobber=True)
...
sp11m2.plotter.savefig('/Users/adam/work/h2co/limabean/figures/avgspectrum_oneone_bgsubtraction.pdf')
sp22m2.plotter.savefig('/Users/adam/work/h2co/limabean/figures/avgspectrum_twotwo_bgsubtraction.pdf')
...
specHDU22bg = fits.PrimaryHDU(data=bgspec,header=spechead)
specHDU22bg.writeto("BackgroundH2CO_22_mask11.fits",clobber=True)
specHDU22 = fits.PrimaryHDU(data=fgspec,header=spechead)
specHDU22.writeto("BrickSpectrumH2CO_22_mask11.fits",clobber=True)

spechead = FITS_tools.strip_headers.speccen_header(cube11h)
fgspec = cube11[:,mask11].mean(axis=1)
bgspec = cube11[:,aperture11].mean(axis=1)
specHDU11bg = fits.PrimaryHDU(data=bgspec,header=spechead)
specHDU11bg.writeto("BackgroundH2CO_11_mask11.fits",clobber=True)
specHDU11 = fits.PrimaryHDU(data=fgspec,header=spechead)
specHDU11.writeto("BrickSpectrumH2CO_11_mask11.fits",clobber=True)
...
sp11m1.plotter.savefig('/Users/adam/work/h2co/limabean/figures/avgspectrum_oneone_bgsubtraction_smooth.pdf')
sp22m1.plotter.savefig('/Users/adam/work/h2co/limabean/figures/avgspectrum_twotwo_bgsubtraction_smooth.pdf')
...
rbg.plotter.savefig('/Users/adam/work/h2co/limabean/figures/avgspectrum_ratio_bgsubtraction_smooth.pdf')
...
r3.plotter.savefig('/Users/adam/work/h2co/limabean/figures/background_avgspectrum_ratio_smooth.pdf')
...
dd.plotter.savefig('/Users/adam/work/h2co/limabean/figures/avgspectrum_11minus22.pdf')
